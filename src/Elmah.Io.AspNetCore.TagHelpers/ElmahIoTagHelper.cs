...
namespace Elmah.Io.AspNetCore.TagHelpers
{
    public class ElmahIoTagHelper(IOptions<ElmahIoOptions> options) : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Attributes.SetAttribute("src", $"https://cdn.jsdelivr.net/gh/elmahio/elmah.io.javascript@4.3.0/dist/elmahio.min.js?apiKey={Options.ApiKey}&logId={Options.LogId}");
        }
    }
}
